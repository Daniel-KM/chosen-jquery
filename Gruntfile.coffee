...
\n
"""
    minified_comments: "/* Chosen <%= version_tag %> | (c) 2011-<%= grunt.template.today('yyyy') %> Patrick Filler & alii | MIT License, https://github.com/Daniel-KM/chosen-jquery/blob/master/LICENSE.md */\n"
