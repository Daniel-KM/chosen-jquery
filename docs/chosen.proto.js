...
Version 2.2.1
Full source at https://github.com/Daniel-KM/chosen-jquery
Copyright (c) 2011-2026 Patrick Filler & alii
MIT License, https://github.com/Daniel-KM/chosen-jquery/blob/master/LICENSE.md
    ...
    class Chosen extends AbstractChosen {
      ...
      set_aria_labels() {
        ...
        if (this.form_field.attributes["aria-label"]) {
          this.search_field.writeAttribute("aria-label", this.form_field.attributes["aria-label"].value);
        }
        if (this.form_field.attributes["aria-labelledby"]) {
          return this.search_field.writeAttribute("aria-labelledby", this.form_field.attributes["aria-labelledby"].value);
